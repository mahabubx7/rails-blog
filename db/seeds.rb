...
u1 = User.create(name: 'Mahabub', bio: 'developer', posts_counter: 0, email: 'test@user.com', encrypted_password: 'ajsdhfjiasdjbchasdbx')
u2 = User.create(name: 'Prince', bio: 'developer', posts_counter: 0, email: 'test@user.com', encrypted_password: 'xkjsdhfwdcmawod')
